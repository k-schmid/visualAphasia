...
class P300PhotoViewer:
	def __init__(self, photo_set, image_indexes, w, h, row, col, online_mode):
		...
		self.mask = GLSprite((os.path.dirname(globals()["__file__"]) + "/gfx/mask.png"), real_size=False)
		self.shadow = GLSprite((os.path.dirname(globals()["__file__"]) + "/gfx/shadow.png"), real_size=False)
		self.frame = GLSprite((os.path.dirname(globals()["__file__"]) + "/gfx/frame.png"), real_size=False)
		self.tick = GLSprite((os.path.dirname(globals()["__file__"]) + "/gfx/tick-icon.png"), real_size=False)
		self.index = 0
		self.visible_images = []
		self.image_space = {}
